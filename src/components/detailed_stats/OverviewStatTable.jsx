      ...
      <Table size="small">
        <TableHead>
          <TableRow>
            ...
            <TableCell>
              {racerType === "driver" ? "Status" : "% Finished"}
            </TableCell>
            <TableCell>
              {racerType === "driver" ? "Stage Points" : "Total Stage Points"}
            </TableCell>
            <TableCell>
              {racerType === "driver" ? "Rating" : "Avg Rating"}
            </TableCell>
          </TableRow>
        </TableHead>
        <TableBody>
          {entityRaces.map((race, index) => (
            ...
            >
              ...
              <TableCell>
                {racerType === "driver" ? race.race_pos : race.race_pos}
              </TableCell>
              <TableCell>
                {racerType === "driver" ? race.quali_pos : race.quali_pos}
              </TableCell>
              <TableCell>
                {racerType === "driver" 
                  ? race.status 
                  : `${race.finish_percentage}%`}
              </TableCell>
              <TableCell>
                {racerType === "driver" 
                  ? race.stage_points 
