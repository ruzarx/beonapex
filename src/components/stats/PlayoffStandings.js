import {
    Paper, Table, TableBody, TableContainer, TableHead, TableRow, TableCell, TableSortLabel, Chip, Avatar, Box, Typography
  } from "@mui/material";
              ...
              {sortedDrivers.map((driver, index) => {
                return (
                  ...
                  >
                    ...
                    <TableCell sx={{ textAlign: "center" }}>{getStandings(currentSeasonStandingsData, driver, "playoff_points")}</TableCell>
                  </TableRow>
                );
              })}
            </TableBody>
