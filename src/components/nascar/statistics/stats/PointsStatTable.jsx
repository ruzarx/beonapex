        ...
        <TableBody>
          {entityRaces.map((race, index) => {
            ...
            return (
              ...
              <TableCell sx={cellStyle}>{race.playoff_points}</TableCell>
              <TableCell sx={cellStyle}>{race.stage_points}</TableCell>
              <TableCell sx={cellStyle}>{race.stage_points_pct}%</TableCell>
              <TableCell sx={cellStyle}>{racerType === "driver" ? (race.season_points + race.playoff_points) : race.avg_points}</TableCell>
            </TableRow>
            );
          })}
        </TableBody>
      ...
      <Table stickyHeader size="small">
        <TableHead>
          <TableRow sx={{ bgcolor: "primary.main" }}>
            ...
            <TableCell onClick={() => handleSort("playoff_points")} sx={{...headerCellStyle, cursor: "pointer" }}>Playoff Points</TableCell>
            <TableCell onClick={() => handleSort("stage_points")} sx={{...headerCellStyle, cursor: "pointer" }}>Stage Points</TableCell>
